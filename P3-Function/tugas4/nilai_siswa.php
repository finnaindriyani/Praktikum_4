...
<form class="form-horizontal" method="POST" autocomplete="off" action="nilai_siswa.php">
  ...
  <div class="form-group row">
    <div class="offset-4 col-8">
      <button name="submit" type="submit" class="btn btn-primary">Proces</button>
    </div>
  </div>
</form>
</body>
...
<?php
  ...
  switch($mata_kuliah){
    case "ddp": $mata_kuliah = "DASAR-DASAR PEMPROGRAMAN"; break;
    case "pw": $mata_kuliah = "PEMPROGRAMANWEB 2"; break;
    case "bs": $mata_kuliah = "BASIS DATA"; break;
    default: "";
}
...
if(isset($_POST['submit'])){?>
                    ...
                    <p>Grade : <?=  $grade = grade($total_nilai);?></p>
                    <p>Predikat : <?=  predikat($grade);?></p>
                    <p>Dengan Ini Dinyatakan <?=  kelulusan($total_nilai);?></p>
